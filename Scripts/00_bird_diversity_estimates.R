...
source("Scripts/Farm_diversity_fns.R")   # latest_file()
...
## Bootstrap replicates -- 500 so the per-assemblage SEs are stable enough to use as measurement error downstream (Scripts/04). Shared by the incidence and the abundance passes.
nboot <- 500
